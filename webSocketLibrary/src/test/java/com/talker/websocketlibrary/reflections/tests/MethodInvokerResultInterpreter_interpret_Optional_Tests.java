...
public class MethodInvokerResultInterpreter_interpret_Optional_Tests {
    void exec(Optional<Object> opt, List<IResultInterpreter> list) {
        new MethodInvokerResultInterpreter(list).interpret(opt);
    }
    @Test
    ...
    @Test
    public void asksCanInterpretMethodOfEachListElement() {
